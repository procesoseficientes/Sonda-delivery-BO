...
namespace NextBO.Wpf.Common
{

    public partial class CollectionViewModel<TEntity, TPrimaryKey, TUnitOfWork>
    {
        public virtual void ItemUpdated(TEntity entity)
        {
            Save(entity);
        }

        /// <summary>
        /// Metodo para crear una nueva ventana desde un CollectionViewModel
        /// Permite poner un titulo a la ventana. si no se le envia uno se mostrara vacio  
        /// </summary>
        /// <param name="viewDocument"></param>
        /// <param name="viewTitle"></param>
        public virtual void ShowDocument(IDocument viewDocument, string viewTitle = null)
        {
            viewDocument.Title = viewTitle ?? string.Empty;
            viewDocument.Show();
        }
